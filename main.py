...
lblEmail.grid(row=2,column=2,padx=5,pady=10,sticky="w")
txtEmail=Entry(entries_frame,textvariable=email,font=("Calibri",16),width=30)
txtEmail.grid(row=2,column=3,padx=5,pady=10,sticky="w")

lblGender=Label(entries_frame,text="gender",font=("Calibri",16),bg="#535c68",fg="white")
lblGender.grid(row=3,column=0,padx=5,pady=10,sticky="w")
comboGender=ttk.Combobox(entries_frame,font=("Calibri",16),width=30,textvariable=gender)
...
lblAddress.grid(row=4,column=0,padx=5,pady=10,sticky="w")
...
btnAdd=Button(btn_frame,command=add_employee,text="Add Details",width=15,font=("Calibri",16,"bold"),fg="white",bg="#16a885",
              bd="0").grid(row=0,column=0)
btnEdit=Button(btn_frame,command=update_employee,text="Update Details",width=15,font=("Calibri",16,"bold"),fg="white",bg="#2988b9",
              bd="0").grid(row=0,column=1,padx=10)
btnDelete=Button(btn_frame,command=delete_employee,text="Delete Details",width=15,font=("Calibri",16,"bold"),fg="white",bg="#c8392b",
              bd="0").grid(row=0,column=2,padx=10)
btnClear=Button(btn_frame,command=clearAll,text="Clear Details",width=15,font=("Calibri",16,"bold"),fg="white",bg="#f39c12",
              bd="0").grid(row=0,column=3,padx=10)


#Table Frame
tree_frame=Frame(root,bg="#ecf8f1")
tree_frame.place(x=0,y=458,width=1370,height=690)
style=ttk.Style()
